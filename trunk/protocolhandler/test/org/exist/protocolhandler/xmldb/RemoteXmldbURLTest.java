...
public class RemoteXmldbURLTest {
    ...
    private static String XMLDB_URL_0 =
            "xmldb:exist://username:password@localhost:8080/exist/xmlrpc" + "/db/shakespeare/plays/macbeth.xml";
    private static String XMLDB_URL_1 =
            "xmldb:exist://guest:guest@localhost:8080/exist/xmlrpc" + "/db/shakespeare/plays/macbeth.xml";
    private static String XMLDB_URL_2 =
            "xmldb:exist://guest@localhost:8080/exist/xmlrpc" + "/db/shakespeare/plays/macbeth.xml";
    private static String XMLDB_URL_3 =
            "xmldb:exist://@localhost:8080/exist/xmlrpc" + "/db/shakespeare/plays/macbeth.xml";
    ...
    private static String XMLDB_URL_22 =
            "xmldb:exist:///exist/xmlrpc" + "/db/shakespeare/plays/macbeth.xml";
